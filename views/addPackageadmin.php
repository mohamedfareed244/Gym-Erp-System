        ...
        <div class="container">
            <div class="row">
                <form action="" class="row">
                    ...
                    <div class="col-lg-4 col-md-12">
                        <label for="name">Number of invitations : </label>
                        <input type="text" name="invitations" id="invitations">
                    </div>
                    <div class="col-lg-4 col-md-12">
                        <label for="name">Number of inbody : </label>
                        <input type="text" name="inbody" id="inbody">
                    </div>
                    <br>
                    <br>
                    <div class="col-lg-4 col-md-12">
                        <label for="name">Number of PT sessions : </label>
                        <input type="text" name="ptsessions" id="ptsessions">
                    </div>
                    <br>
                    <br>
