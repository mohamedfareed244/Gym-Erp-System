        ...
        <div class="card" style="border-radius: 1rem;">
          <div class="row g-0">
            <div class="col-md-6 col-lg-5 d-none d-md-block">
              <img src="../public/Images/young-man-sportswear-exercise-class-gym_1150-12372.jpg"
                alt="login form" class="img-fluid" style="border-radius: 1rem 0 0 1rem; margin-top:25%; margin-left:10px;" />
            </div>
